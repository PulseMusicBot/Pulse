...
public class VoiceDetection implements SlashCommandComponentHandler {

    private static final Setting setting = Setting.VOICE_DETECTION;

    private static final OptionData data = new OptionData(OptionType.BOOLEAN, "state", "Whether to enable audio suppression on voice detection.");
