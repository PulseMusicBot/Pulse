...
public class PlayerPauseEvent extends Event implements Cancellable {
    ...
    public PlayerPauseEvent(Controller controller, PlayerListener playerListener, AudioPlayer audioPlayer) {
