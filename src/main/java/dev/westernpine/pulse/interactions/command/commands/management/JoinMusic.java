...
public class JoinMusic implements SlashCommandComponentHandler {

    private static final Setting setting = Setting.JOIN_MUSIC;

    private static final OptionData data = new OptionData(OptionType.STRING, "music", "The default music to play when joining.");
