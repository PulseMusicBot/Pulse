...
public class ShufflePlaylists implements SlashCommandComponentHandler {
    ...
    private static final Setting setting = Setting.SHUFFLE_PLAYLISTS;

    private static final OptionData data = new OptionData(OptionType.BOOLEAN, "state", "Whether to shuffle playlists.");
