...
public class TwentryFourSeven implements SlashCommandComponentHandler {

    private static final Setting setting = Setting.TWENTY_FOUR_SEVEN;

    private static final OptionData data = new OptionData(OptionType.BOOLEAN, "state", "Whether to enable 24/7 mode.");
