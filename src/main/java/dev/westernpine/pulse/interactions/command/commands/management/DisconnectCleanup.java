...
public class DisconnectCleanup implements SlashCommandComponentHandler {

    private static final Setting setting = Setting.DISCONNECT_CLEANUP;

    private static final OptionData data = new OptionData(OptionType.BOOLEAN, "state", "Whether to remove a user's votes and queues when they leave.");
