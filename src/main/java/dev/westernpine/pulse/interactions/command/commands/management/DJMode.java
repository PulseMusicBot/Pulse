...
public class DJMode implements SlashCommandComponentHandler {

    private static final Setting setting = Setting.DJ_MODE;

    private static final OptionData data = new OptionData(OptionType.BOOLEAN, "state", "Whether to enable DJ mode.");
