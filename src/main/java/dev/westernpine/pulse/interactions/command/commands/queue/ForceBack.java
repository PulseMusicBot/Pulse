...
public class ForceBack implements SlashCommandComponentHandler {
    ...
    public String description() {
        return "Force-skip to the previous track.";
    }
    ...
    public boolean handle(SlashCommandEvent event) {
        ...
        Messenger.replyTo(event, Embeds.success("Force-skipped to the previous track.", ""), 15);
        return true;
    }
}
