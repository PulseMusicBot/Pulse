...
public class DefaultVolume implements SlashCommandComponentHandler {
    ...
    private static final Setting setting = Setting.DEFAULT_VOLUME;

    private static final OptionData data = new OptionData(OptionType.INTEGER, "level", "The level to set the volume to.");
    ...
    public boolean handle(SlashCommandEvent event) {
        ...
        if (option == null) {
            ...
            settings.set(setting, Value.of(Numbers.setWithin(option.getAsLong(), 0, 100)));
